...
class DragComponent extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Wrap, null,
            React.createElement("ul", null, renderDom.map((e, i) => {
                return (React.createElement("li", { key: i, draggable: true },
                    ...
                    React.createElement("span", { className: "content" },
                        "\u5185\u5BB9Content\u5185\u5BB9",
                        e),
                    React.createElement("span", { className: "hand" }, this.state.targetDrag ? React.createElement(icon_1.default, { type: "arrows-alt" }) : '☰')));
            }))));
    }
}
