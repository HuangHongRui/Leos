...
const icon_1 = require("antd/lib/icon");
...
`;
class DragComponent extends react_1.default.Component {
    constructor() {
        super(...arguments);
        this.state = {
            targetDrag: false,
    ...
    render() {
        ...
        return (react_1.default.createElement(Wrap, null,
            react_1.default.createElement("ul", null, renderDom.map((e, i) => {
                return (react_1.default.createElement("li", { key: i, draggable: true },
                    react_1.default.createElement("span", { className: "serial" }, e),
                    react_1.default.createElement("span", { className: "content" },
                        "\u5185\u5BB9Content\u5185\u5BB9",
                        e),
                    react_1.default.createElement("span", { className: "hand" }, this.state.targetDrag ? react_1.default.createElement(icon_1.default, { type: "arrows-alt" }) : '☰')));
            }))));
    }
}
